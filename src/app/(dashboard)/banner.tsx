...
const Banner = () => {
  ...
  return (
    <div className="text-white w-full max-w-full overflow-hidden aspect-[5/1] min-h-[248px] flex gap-x-6 p-6 items-center rounded-xl bg-gradient-to-r from-[#2e62cb] via-[#0073ff] to-[#3faff5]">
